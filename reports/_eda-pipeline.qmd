...
1. **Unlabelled Image Ingestion**  
   The pipeline begins by collecting raw, unlabelled images from the client’s data sources (`fetch_data.py`).
...
3. **Human-in-the-Loop Review**  
   Experts review and correct the pre-labels to ensure high-quality annotations with minimal manual effort (`human_intervention.py`).
