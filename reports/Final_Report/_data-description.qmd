...
The object detection task focuses on five categories:  
1. Fire  
2. Smoke  
3. Lightning  
4. Vehicle  
...
The partner expects approximately 500 new images per month, which the pipeline is designed to process through labeling, training, and compression stages.