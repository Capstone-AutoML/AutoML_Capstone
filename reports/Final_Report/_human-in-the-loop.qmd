...
2. **Workflow Steps**
   ...
   ![Human-in-the-loop workflow diagram](img/human-in-the-loop_diagram.png){#fig-human-review width="40%"}

   - **Step 1:** Place mismatched prediction files in `label_studio/pending/`
   - **Step 2:** Run the script to convert them into Label Studio tasks using images from `input/`
   - **Step 3:** Review and fix labels visually in the intuitive Label Studio interface as shown in @fig-label-studio

     ![Label Studio Interface for Human Review](img/label_studio_interface.png){#fig-label-studio width="80%"}

   - **Step 4:** Export the reviewed results to `label_studio/results/` 

   - **Step 5:** Reviewed prediction files are moved from pending directory to  
     `labeled/`, available for the training phase
