...
Early detection is critical for limiting their spread and minimizing damage [@drdc2022].

Our Capstone partner, Bayes Studio, is a Vancouver-based startup that uses advanced AI tools for environmental monitoring and early wildfire detection. 
...
Ultimately, this reduces the system's effectiveness for real-time fire detection.
...
If both models agree, the image is accepted, otherwise it will be flagged for human review through a lightweight interface like Label Studio.
